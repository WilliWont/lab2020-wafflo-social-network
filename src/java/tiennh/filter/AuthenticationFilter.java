    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try{
            ...
            if(email != null && password != null){
                ...
                loginDTO = new UserTableDAO().loginAccount(email, password);
            } // has both username and password
            
            if(loginDTO != null){
                System.out.println("login succ");
                Cookie loginCookie = new Cookie("s2020l1",email + '.' + password);
                loginCookie.setMaxAge(60*AccountHelper.COOKIE_AGE);
            ...
            log("AutheticationFilter-"+t.getMessage());
        }
        finally{
            System.out.println("------------------------");
        }
